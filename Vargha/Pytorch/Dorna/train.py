...
from torchtrainer.callbacks import CSVLogger, checkpoint
...
def training(model, ds_train, ds_valid, criterion, optimizer, scheduler, device, epochs):
    ...
    for epoch in range(epochs):
        ...
        CSVLogger('/home/vargha/Desktop/Vargha/Pytorch/Dorna/csv_log')
        scheduler.step(total_loss_valid)
        checkpoint.Checkpoint(directory="/home/vargha/Desktop/Vargha/Pytorch/Dorna/saved/", filename='checkpoint', best_filename='best',  monitor=valid_losses)
        # if Early_Stopping:
        #     break
        # else:
        #     continue
